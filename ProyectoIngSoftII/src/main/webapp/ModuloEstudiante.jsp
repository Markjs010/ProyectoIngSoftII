...
<body>
	...
	<div class="containerEncabezado">
		...
		<div id="divtitulo" style="text-align: Center;">
			<label id="titulo" for="titulo">MODULO DE ACCESO ESTUDIANTES</label>
		</div>
	...
	<div class="containerIzq">
		<div style="text-align: center;">
			<button id="btn__verAlumno">Información Personal</button>
		</div>
		<div style="text-align: center;">
			<button id="btn__verPrestamo">Prestamos</button>
		</div>
	</div>
							...
							<div id="TableDocente"
								...
								<table id="example"
									...
									<thead>
										<tr role="row">
											<th class="sorting_asc" tabindex="0" aria-controls="example"
												...
												style="width: 63px;">ID Indumentaria</th>
											<th class="sorting" tabindex="0" aria-controls="example"
												rowspan="1" colspan="1"
												aria-label="Puesto: activate to sort column ascending"
												style="width: 56px;">Descripción</th>
											<th class="sorting" tabindex="0" aria-controls="example"
												rowspan="1" colspan="1"
												aria-label="Año de Ingreso: activate to sort column ascending"
									...
									<tbody>
										...
										<tr role="row">
											<td class="sorting_1"><%=prestamo.getId()%></td>
											<td><%=prestamo.getDescripcion()%></td>
								...
								<div class="dt-buttons btn-group" style="text-align: left;">
									<button class="btn btn-success" tabindex="0"
										aria-controls="example" type="button" title="Exportar a Excel">
